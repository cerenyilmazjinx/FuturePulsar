...
#[derive(Debug)]
pub struct FuturePulsarProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FuturePulsarProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FuturePulsar processing");
    
    let mut processor = FuturePulsarProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FuturePulsarProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FuturePulsarProcessor::new(false);
